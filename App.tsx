  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (mode === 'standard') {
        ...
        // Default to mp3 if type is missing, to prevent API errors
        const mimeType = cloneFile.type || 'audio/mp3';
        base64Data = await generateClonedSpeech(text, audioBase64, mimeType);
      }
